...
class QuoteCalculatorForm(FlaskForm):
    ...
    deadhead_miles = FloatField("Deadhead Miles", default=0, validators=[Optional(), NumberRange(min=0)])
    ...
    is_weekend = BooleanField("Saturday")
    is_sunday = BooleanField("Sunday")
...
class PricingSettingsForm(FlaskForm):
    ...
    loaded_miles_included = FloatField("Loaded Miles Included", validators=[DataRequired()])
    loaded_mile_charge = FloatField("Loaded Mile Rate After Included ($)", validators=[DataRequired()])
    deadhead_miles_included = FloatField("Deadhead Miles Included", validators=[DataRequired()])
    deadhead_mile_charge = FloatField("Deadhead Mile Rate After Included ($)", validators=[DataRequired()])
    ...
    weekend_charge = FloatField("Saturday Surcharge ($)")
    holiday_charge = FloatField("Sunday/Holiday Charge ($)")
    sunday_holiday_customer_quote = BooleanField("Sunday/Holiday Requires Customer Quote")
    wait_time_included_minutes = FloatField("Wait Minutes Included", validators=[DataRequired()])
    wait_time_block_minutes = FloatField("Wait Billing Block (Minutes)", validators=[DataRequired()])
    wait_time_per_block = FloatField("Wait Charge Per Block ($)", validators=[DataRequired()])
